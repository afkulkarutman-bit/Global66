      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <span style={{ color: "#fff", fontWeight: 700, fontSize: 16, letterSpacing: "-0.2px" }}>People</span>
          </div>
          {/* Tabs */}
            ...
            {menuOpen && (
              <>
                ...
                <div style={{
                  ...
                  <a href="/respuesta-formulario" style={{ display: "block", padding: "12px 18px", fontSize: 14, fontWeight: 500, color: "var(--g66-text)", textDecoration: "none", borderBottom: "1px solid var(--g66-border)" }}
                    onMouseEnter={e => (e.currentTarget.style.background = "#f5f6fa")}
                    onMouseLeave={e => (e.currentTarget.style.background = "#fff")}>
